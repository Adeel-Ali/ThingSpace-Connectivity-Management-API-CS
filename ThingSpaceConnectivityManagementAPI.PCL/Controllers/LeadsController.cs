...
{
    public partial class LeadsController: BaseController
    {
        ...
        /// </summary>
        internal static LeadsController Instance
        {
            get
            {
                lock (syncObject)
        ...
        /// <return>Returns the LeadInformationResponse response from the API call</return>
        public LeadInformationResponse GetListUsingGET1(string vZM2MToken, string aname, long? next = null)
        {
            Task<LeadInformationResponse> t = GetListUsingGET1Async(vZM2MToken, aname, next);
            Task.WaitAll(t);
            return t.Result;
        }
        ...
        /// <param name="next">Optional parameter: Continue the previous query from the pageUrl in Location Header</param>
        /// <return>Returns the LeadInformationResponse response from the API call</return>
        public async Task<LeadInformationResponse> GetListUsingGET1Async(string vZM2MToken, string aname, long? next = null)
        {
            ...
            try
            {
                return APIHelper.JsonDeserialize<LeadInformationResponse>(_response.Body);
            }
            catch (Exception _ex)
            {
